...
//var url_json = "http://218.151.87.147:888/";
//var url_json = "http://yjsoft1.cafe24.com:8357/";

//var url_json = "http://192.168.1.10:8080/"
//var url_json = "http://127.0.0.1:8080/"
...
var page_pause_time_adminmenu = 6000;          //사용자 터치 시 디스플레이 주기적 회전 대기시간 (관리자)	     (6000 = 100분)         //관리자가 입력할 경우 사용
var snap_size = 0;
...
// donotshow_signpage();       //로그인 페이지 지나치기
// selectConfigration();
// check_rotate_page_display_menu();

function donotshow_signpage() {
    //다음 페이지 디스플레이
...
function indexedDB_open (result) {
    ...
    var openDB = indexedDB.open("ftmsdb", 4);       //db생성  
...
function saveJSON(data, filename){
    ...
    //var isExist = a.href.indexOf("cefsharp");
    //if (isExist !== -1) {
    //    var getHref = a.href.replace("localfolder://cefsharp", "http://127.0.0.1:31419");
    //    a.href = getHref;
    //}

    //a.dataset.downloadurl = ['text/json', a.download, a.href].join(':');
    //if (isExist !== -1) {
    //    var getUrl = a.dataset.downloadurl.replace("localfolder://cefsharp", "http://127.0.0.1:31419");
    //    a.dataset.downloadurl = getUrl;
    //}
    //alert(a.href);
    //alert(a.dataset.downloadurl);
    //e.initMouseEvent('click', true, false, window, 0, 0, 0, 0, 0, false, false, false, false, 0, null);
    //a.dispatchEvent(e);
            ...
            try {
                ...
                function saveListNext(store_name) {
                    indexedDB_storeClear(store_name, function(e) {
                        for (i=0; i<indexedDB_backup.length; i++) {
